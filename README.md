...
DuckButton.Image = "rbxassetid://13285615740" -- Замени на ID утки
...
ScriptsFrame.Size = UDim2.new(1, -20, 1, -180)
ScriptsFrame.Position = UDim2.new(0, 10, 0, 150)
...
local function CreateScriptButton(text, position)
...
ScriptsFrame.CanvasSize = UDim2.new(0, 0, 0, (#ScriptButtons * 53) + ((#ScriptButtons - 1) * 8))
...
-- СЮДА ВСТАВЛЯЙ СВОИ СКРИПТЫ:

ScriptButtons[1].MouseButton1Click:Connect(function()
...
ScriptButtons[2].MouseButton1Click:Connect(function()
...
ScriptButtons[3].MouseButton1Click:Connect(function()
    local Players = game:GetService("Players")
local RunService = game:GetService("RunService")
local Player = Players.LocalPlayer
...
ScriptButtons[4].MouseButton1Click:Connect(function()
...
ScriptButtons[5].MouseButton1Click:Connect(function()
    local player = game.Players.LocalPlayer
...
ScriptButtons[6].MouseButton1Click:Connect(function()
    --[[ 
...
-- Аимбот (Скрипт 7)
ScriptButtons[7].MouseButton1Click:Connect(function()
    -- АИМБОТ СКРИПТ
    getgenv().AimbotEnabled = not getgenv().AimbotEnabled
    
    if getgenv().AimbotEnabled then
        print("Аимбот активирован")
        -- Твой код аимбота здесь
    else
        print("Аимбот деактивирован")
        -- Код отключения аимбота
    end
end)

-- ESP игроков (Скрипт 8)
ScriptButtons[8].MouseButton1Click:Connect(function()
    -- ESP СКРИПТ
